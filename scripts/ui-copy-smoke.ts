...
assert.match(hub, /EXPEDITION_ACTIONS: ExpeditionAction\[\] = \["continue", "newRun", "hard", "challenge", "close"\]/);
assert.match(hub, /case "open_rebirth_spring"[\s\S]*hubMode: true/);
...
assert.match(character, /private hubMode = false/);
