...
const objects: WorldObjectDefinition[] = [
  ...
  decoration("north_waystone", 39, 15, 3, 4, "waystone", "sorted", { accent: "#9B74D5", direction: "north" }, "footprint"),
  decoration("south_waystone", 39, 44, 3, 4, "waystone", "sorted", { accent: "#9B74D5", direction: "south" }, "footprint"),
