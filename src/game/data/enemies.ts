...
export const ENEMIES: Record<string, EnemyDefinition> = {
  ...
  dingdong_fowl: enemy({
    ...
    color: "#F1C40F", maxHp: 6, speed: 34, radius: 7, attackDamage: 1, attackInterval: 1.05, attackWindup: 0.34,
  ...
  broadcast_rooster: enemy({
    ...
    color: "#D4AC0D", maxHp: 48, speed: 34, radius: 14, attackDamage: 3, attackInterval: 1.95, attackWindup: 0.52,
  ...
  bark_hound: enemy({
    ...
    color: "#8D6E63", maxHp: 10, speed: 43, radius: 8, attackDamage: 3, attackInterval: 1.35, attackWindup: 0.42,
    chargeDistance: 66,
  }),
  chain_jailer: enemy({
  ...
  kennel_warden: enemy({
    ...
    color: "#8D6E63", maxHp: 62, speed: 31, radius: 15, attackDamage: 4, attackInterval: 2.05, attackWindup: 0.56,
  ...
  code_horse: enemy({
    ...
    color: "#FFB74D", maxHp: 16, speed: 38, radius: 10, attackDamage: 4, attackInterval: 1.5, attackWindup: 0.5,
  ...
  furnace_beetle: enemy({
    ...
    color: "#D84315", maxHp: 14, speed: 20, radius: 9, attackDamage: 4, attackInterval: 1.65, attackWindup: 0.5,
  ...
  vat_horse_prime: enemy({
    ...
    color: "#FF8A65", maxHp: 74, speed: 32, radius: 16, attackDamage: 4, attackInterval: 1.82, attackWindup: 0.5,
