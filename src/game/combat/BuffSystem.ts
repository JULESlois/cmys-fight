...
export const BUFFS: Record<BuffId, BuffDefinition> = {
  ...
  rebound_rounds: { id: "rebound_rounds", name: "REBOUND ROUNDS", description: "Projectiles bounce once from walls. Bounced shots deal +20% damage.", shortCode: "BNC", rarity: "uncommon", category: "weapon", family: "vanguard", tags: ["bounce"], synergyKeys: ["rebound_rounds", "elemental_rounds", "piercing_shots"] },
  ...
  execution_window: { id: "execution_window", name: "EXECUTION WINDOW", description: "Enemies below 25% HP are marked. +20% damage to marked. Kills restore 1 energy. Boss: 15% threshold.", shortCode: "EXW", rarity: "rare", category: "weapon", family: "vanguard", tags: ["execute", "energy"], triggers: ["onHit", "onKill"], synergyKeys: ["execution_window", "trigger_discipline"] },
  counter_strike: { id: "counter_strike", name: "COUNTER STRIKE", description: "Perfect dodge empowers next attack: +35% damage, +20% speed for 3s.", shortCode: "CTR", rarity: "common", category: "weapon", family: "echo", tags: ["dodge", "damage"], triggers: ["onPerfectDodge"], synergyKeys: ["counter_strike", "afterimage_capture"] },
