...
export class EntityRenderer {
  ...
  public static drawPlayer(ctx: CanvasRenderingContext2D, player: Player, engine: any, theme: string) {
    ...
    } else if (hasExtendedPlayerAnimation && player.animFrame % 2 === 1) {
    ...
    if (player.characterId === "mage") {
      EntityRenderer.drawArcanePrisms(ctx, player, false);
    }
    ...
    if (player.characterId === "mage") {
      EntityRenderer.drawArcanePrisms(ctx, player, true);
    }
