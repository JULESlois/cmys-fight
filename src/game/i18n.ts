...
const EN = {
  ...
  "preview.threat": "THREAT",
  "preview.tags": "TAGS",
  "preview.unknown": "UNKNOWN",
  "notice.combatStarted": "COMBAT START",
  "notice.bossCombatStarted": "BOSS ENGAGED",
  "notice.combatCleared": "ROOM CLEAR",
  "notice.purchaseFailed": "PURCHASE FAILED",
  "notice.chapter.1.title": "CHAPTER I",
  "notice.chapter.1.name": "VERDANT FRONTIER",
  "notice.chapter.2.title": "CHAPTER II",
  "notice.chapter.2.name": "FORGOTTEN DUNGEON",
  "notice.chapter.3.title": "CHAPTER III",
  "notice.chapter.3.name": "FROZEN RESEARCH ZONE",
  "notice.chapter.4.title": "CHAPTER IV",
  "notice.chapter.4.name": "INFERNAL FOUNDRY",
  "zone.overgrown_archive": "OVERGROWN ARCHIVE",
  "zone.sealed_library": "SEALED LIBRARY",
  "zone.cooling_canal": "COOLING CANAL",
  "zone.sealed_armory": "SEALED ARMORY",
  "zone.observatory": "ASTRAL OBSERVATORY",
  "zone.forge_core": "FORGE CORE",
  "zone.ash_catacombs": "ASH CATACOMBS",
  "zone.deep_prison": "DEEP PRISON",
  "zone.deep_archive": "DEEP ARCHIVE",
  "pause.title": "PAUSED",
  ...
  "hud.subWeapon": "SUB",
  "hud.crush": "CRUSH",
  "hud.noSubWeapon": "NONE",
  "subweapon.dagger": "DAGGER",
  "subweapon.axe": "AXE",
  "subweapon.cross": "CROSS",
  "subweapon.holy_water": "HOLY WATER",
  "subweapon.stopwatch": "STOPWATCH",
  "subweapon.bible": "BIBLE",
  "subweapon.pickup": "PICK UP {name}",
  "subweapon.replaced": "SWAPPED FOR {name}",
  "soul.obtained": "SOUL: {name}",
  "soul.duplicate": "SOUL ECHO",
  "soul.type.bullet": "BULLET",
  "soul.type.guardian": "GUARDIAN",
  "soul.type.enchant": "ENCHANT",
  "soul.type.ability": "ABILITY",
  "soul.collection": "SOULS {owned}/{total}",
  "soul.empty": "EMPTY",
  "equip.slot.hand": "HAND",
  "equip.slot.armor": "ARMOR",
  "equip.slot.accessory": "CHARM",
  "stat.strength": "STR",
  "stat.constitution": "CON",
  "stat.intelligence": "INT",
  "stat.luck": "LCK",
  "gate.chasm.locked": "A GAP TOO WIDE TO CROSS",
  "gate.crawlspace.locked": "TOO LOW TO ENTER UPRIGHT",
  "gate.grate.locked": "BARRED. SOLID FORM WILL NOT PASS",
  "gate.ice_field.locked": "NO FOOTING ON THE ICE",
  "gate.heat_corridor.locked": "THE AIR HERE WOULD COOK YOU",
  "gate.opened": "WAY OPENED",
  "map.exploration": "MAP {percent}",
  "map.blocked": "SEALED {count}",
  "story.speaker.narrator": "",
  "story.speaker.archivist": "ARCHIVIST",
  "story.speaker.signal": "SIGNAL",
  "story.speaker.director": "DIRECTOR",
  "story.speaker.overseer": "OVERSEER",
  "story.speaker.rooster": "ROOSTER",
  "story.speaker.memory": "OLD MEMORY",
  "story.continue": "[{key}] CONTINUE",
  "story.skip": "[{key}] SKIP",
  "ending.ending_true": "TRUE ARCHIVE",
  "ending.ending_mercy": "THE KIND ROUTE",
  "ending.ending_ascent": "ASCENT",
  "ending.ending_archive": "FILED AWAY",
  "ending.ending_default": "NO RECORD",
  ...
  "hub.waystone": "WAYSTONE",
  "hub.waystoneMessage": "THE WAYSTONE HUMS WITH SANCTUARY ROUTES",
  "hub.panelFooter": "[{vertical}] MOVE   [{confirm}] SELECT   [{cancel}] BACK",
  "hub.expedition.continue": "CONTINUE RUN",
  "hub.expedition.start": "START EXPEDITION",
  "hub.expedition.abandon": "ABANDON RUN",
  "hub.expedition.close": "RETURN TO SANCTUARY",
  "hub.expedition.confirmReplace": "CONFIRM AGAIN TO ABANDON THE ACTIVE RUN AND START",
  "hub.expedition.confirmAbandon": "CONFIRM AGAIN TO ABANDON THE ACTIVE RUN",
  "hub.expedition.abandoned": "ACTIVE RUN ABANDONED",
  "hub.expedition.loadoutSummary": "LOADOUT  {character} / {weapon}",
  "hub.expedition.rulesSummary": "RULES  {difficulty} / {challenge}",
  "hub.trialTitle": "TRIAL ALTAR",
  "hub.trial.hard": "HARD MODE",
  "hub.trial.challenge": "DAILY CHALLENGE",
  "hub.trial.close": "RETURN TO SANCTUARY",
  "hub.trialReward": "REWARD: +{reward} SHARDS",
  ...
  "rebirth.loadoutOnly": "REBIRTH LOADOUT — SAVED FOR THE NEXT EXPEDITION",
...
const ZH: Partial<Record<TranslationKey, string>> = {
  ...
  "preview.tags": "标签",
  "preview.unknown": "未知",
  "notice.combatStarted": "战斗开始",
  "notice.bossCombatStarted": "首领战开始",
  "notice.combatCleared": "房间已清理",
  "notice.purchaseFailed": "购买失败",
  "notice.chapter.1.title": "第一章",
  "notice.chapter.1.name": "翠绿边境",
  "notice.chapter.2.title": "第二章",
  "notice.chapter.2.name": "遗忘地牢",
  "notice.chapter.3.title": "第三章",
  "notice.chapter.3.name": "冰封研究区",
  "notice.chapter.4.title": "第四章",
  "notice.chapter.4.name": "炼狱铸造厂",
  "pause.title": "已暂停",
  ...
  "subweapon.axe": "战斧",
  "subweapon.cross": "十字架",
  "subweapon.holy_water": "圣水",
  "subweapon.stopwatch": "怀表",
  "subweapon.bible": "圣书",
  "subweapon.pickup": "拾取{name}",
  "subweapon.replaced": "已换为{name}",
  "soul.obtained": "获得魂：{name}",
  "soul.duplicate": "魂之回响",
  "soul.type.bullet": "弹魂",
  "soul.type.guardian": "守护魂",
  "soul.type.enchant": "强化魂",
  "soul.type.ability": "能力魂",
  "soul.collection": "魂 {owned}/{total}",
  "soul.empty": "空",
  "equip.slot.hand": "手部",
  "equip.slot.armor": "护甲",
  "equip.slot.accessory": "饰品",
  "stat.strength": "力",
  "stat.constitution": "体",
  "stat.intelligence": "智",
  "stat.luck": "运",
  "gate.chasm.locked": "裂隙太宽，无法跨越",
  "gate.crawlspace.locked": "太低矮，站着进不去",
  "gate.grate.locked": "铁栅封锁，实体无法通过",
  "gate.ice_field.locked": "冰面上站不住脚",
  "gate.heat_corridor.locked": "这里的空气会把你烤熟",
  "gate.opened": "道路已开启",
  "map.exploration": "地图 {percent}",
  "map.blocked": "封锁 {count}",
  "story.speaker.narrator": "",
  "story.speaker.archivist": "档案管理员",
  "story.speaker.signal": "信号",
  "story.speaker.director": "主管",
  "story.speaker.overseer": "监视者",
  "story.speaker.rooster": "广播雄鸡",
  "story.speaker.memory": "旧日记忆",
  "story.continue": "[{key}] 继续",
  "story.skip": "[{key}] 跳过",
  "ending.ending_true": "真实档案",
  "ending.ending_mercy": "仁慈之路",
  "ending.ending_ascent": "登临",
  "ending.ending_archive": "归档",
  "ending.ending_default": "查无此人",
  ...
  "hub.wishGarden": "靠近愿泉",
  "hub.interact": "交互",
  "zone.overgrown_archive": "蔓生树海",
  "zone.sealed_library": "封印书库",
  "zone.cooling_canal": "冷却运河",
  "zone.sealed_armory": "封印军械库",
  "zone.observatory": "星象观测台",
  "zone.forge_core": "锻造核心",
  "zone.ash_catacombs": "余烬地下穴",
  "zone.deep_prison": "深渊监牢",
  "zone.deep_archive": "深渊底层",
  ...
  "hub.waystone": "路标石",
  "hub.waystoneMessage": "路标石正低鸣着圣所中的路径",
  "hub.panelFooter": "[{vertical}] 移动   [{confirm}] 选择   [{cancel}] 返回",
  "hub.expedition.continue": "继续远征",
  "hub.expedition.start": "开始远征",
  "hub.expedition.abandon": "放弃当前远征",
  "hub.expedition.close": "返回圣所",
  "hub.expedition.confirmReplace": "再次确认：放弃当前远征并开始新远征",
  "hub.expedition.confirmAbandon": "再次确认：放弃当前远征",
  "hub.expedition.abandoned": "已放弃当前远征",
  "hub.expedition.loadoutSummary": "配置  {character} / {weapon}",
  "hub.expedition.rulesSummary": "规则  {difficulty} / {challenge}",
  "hub.trialTitle": "试炼祭坛",
  "hub.trial.hard": "困难模式",
  "hub.trial.challenge": "每日挑战",
  "hub.trial.close": "返回圣所",
  "hub.trialReward": "奖励：+{reward} 碎片",
  "hub.title": "深潜基地",
  ...
  "rebirth.loadoutOnly": "重生配置——仅保存给下一次远征",
...
const BUFF_ZH: Record<string, { name: string; description: string }> = {
  ...
  counter_strike: { name: "反相反击", description: "完美闪避后下次攻击伤害 +35%，弹速 +20%，持续 3 秒。" },
  trigger_discipline: { name: "持续射击", description: "连续射击 0.8 秒后弹速 +15%，散布逐渐收紧。停止后 0.5 秒消退。" },
  execution_window: { name: "处决窗口", description: "生命低于 25% 的敌人被标记，对标记敌人伤害 +20%，击杀恢复 1 能量。" },
  afterimage_capture: { name: "残像摄影", description: "完美闪避后留下 1.5 秒残像吸引弹丸。冷却 6 秒。" },
  cross_swap: { name: "交叉换装", description: "换枪后 1.2 秒内攻速提升，返还少量能量。冷却 3 秒。" },
  alternating_current: { name: "交替电流", description: "两把武器 2 秒内交替命中积累同步，4 层后释放连锁电弧。" },
  momentum_store: { name: "动量储蓄", description: "连续移动 1.5 秒后下次攻击获得穿透、击退与冲击波。" },
  graze_relay: { name: "擦弹继电器", description: "每 5 次擦弹恢复 8 能量并缩短闪避冷却 0.5 秒。" },
  reactive_armor: { name: "反应式装甲", description: "护甲破裂后获得 2 秒弹丸减伤与击退脉冲。每房一次。" },
  bulwark_memory: { name: "壁垒记忆", description: "靠近建筑时护甲恢复 +50%，击退降低。离开后失效。" },
  chain_directive: { name: "连锁指令", description: "使用技能后下次攻击连锁附近敌人，造成 35% 伤害。" },
  battlefield_salvage: { name: "战场拾荒", description: "每摧毁 5 个场景物生成补给球。每房最多 2 次。" },
  hazard_lens: { name: "危险解析镜", description: "受到的环境伤害 -30%，敌人受到的环境伤害 +20%。" },
  terminal_override: { name: "终端越权", description: "设施增加一个选项，每章一次设施重投。" },
  secret_sense: { name: "秘径感知", description: "存在隐藏连接的房间会出现微弱音效提示。" },
  route_assessment: { name: "路线评估", description: "检查出口时额外显示一项敌人/环境/奖励信息。" },
  perfect_survey: { name: "完美勘测", description: "无伤清理房间后揭示隐藏连接或相邻房间奖励。" },
  blood_pact_engine: { name: "血契引擎", description: "最大生命 -2，所有直接伤害 +20%。无伤清房恢复 1 生命。" },
  cursed_compass: { name: "诅咒罗盘", description: "出口奖励提示隐藏，隐藏房出现率提高，隐藏奖励品质 +1。" },
  hollow_armor: { name: "空壳装甲", description: "最大护甲 +4，战斗中无法自然恢复。护甲破裂时释放清弹脉冲。" },
};
