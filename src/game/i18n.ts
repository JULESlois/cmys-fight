...
const EN = {
  ...
  "notice.combatStart": "COMBAT START",
  "notice.bossStart": "BOSS ENGAGED",
  "notice.rewardGenerated": "REWARD AVAILABLE",
...
const ZH: Partial<Record<TranslationKey, string>> = {
  ...
  "notice.combatStart": "战斗开始",
  "notice.bossStart": "首领战开始",
  "notice.rewardGenerated": "奖励已生成",
