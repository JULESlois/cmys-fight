...
const EN = {
  ...
  "settings.footer": "↑↓ MOVE   ←→ CHANGE   ENTER   ESC",
  "settings.controlsFooter": "ENTER BIND   R RESET   ESC",
  ...
  "pause.footer": "[{menu}] MENU    [{pause}] RESUME",
  "buff.title": "TALENT",
  ...
  "character.footer": "←→ CHARACTER   ENTER START   ESC",
  ...
  "records.footer": "Q/E PAGE   W/S SELECT   ESC",
...
const ZH: Partial<Record<TranslationKey, string>> = {
  ...
  "settings.footer": "↑↓ 移动   ←→ 修改   确认   ESC",
  "settings.controlsFooter": "确认绑定   R 重置   ESC",
  ...
  "records.weapons": "武器",
  "records.talents": "天赋",
  "records.footer": "Q/E 翻页   W/S 选择   ESC",
...
const BUFF_ZH: Record<string, { name: string; description: string }> = {
  scattershot: { name: "散射核心", description: "弹丸数量 +2，伤害 -15%。" },
  rapid_fire: { name: "高速循环器", description: "射速 +25%，伤害 -10%。" },
  heavy_rounds: { name: "重型弹药", description: "伤害与击退 +30%，射速 -15%。" },
  ...
  overclock_core: { name: "超频核心", description: "射速 +35%，伤害 +10%。" },
  execution_matrix: { name: "处决矩阵", description: "伤害 +30%，暴击率 +15%。" },
  phase_storm: { name: "相位风暴", description: "弹丸数量、穿透和墙壁反弹各 +1。" },
  mana_well: { name: "能量之井", description: "最大能量 +40，加快回复，武器消耗 -25%。" },
  skill_loop: { name: "技能循环", description: "技能冷却 -30%；使用技能恢复 15 点能量。" },
  entropy_engine: { name: "熵能引擎", description: "伤害 +15%；击杀恢复 4 点能量。" },
